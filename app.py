...
def load_data(shovel):
    ...
    for month in months:
        ...
        try:
            ...
            if 'Truck fill' in month_data.columns and 'Shovel' in month_data.columns:
                filtered_data = month_data[month_data['Shovel'] == shovel]['Truck fill']
                shovel_fill_data.extend(filtered_data.dropna())
